...
<html>
  ...
  String subid=request.getParameter("subjects");
   String filePath = "http://localhost:8080/gurusisyas/uploads/";
    ...
    ResultSet rs;
    rs = st.executeQuery("select file, first_name, last_name, DATE(uploaded_date) as date from newassignment a inner join teacher u on a.teacher_id=u.id where a.subject_id='" + subid + "'");
   %>
